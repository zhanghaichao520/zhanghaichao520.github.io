...
## 二 分布式文件系统HDFS
 ...
 4. HDFS环境搭建
    ...
    - 下载解压hadoop安装包：`tar -zxvf hadoop-2.6.0-cdh5.7.0.tar.gz -C ~/hadoop`
	- 配置文件修改（～/hadoop/etc/hadoop/):   
	
    	hadoop-env.sh:加入JAVA_HOME环境 `export JAVA_HOME=/Library/Java/JavaVirtualMachines/jdk1.8.0_171.jdk/Contents/Home`  
